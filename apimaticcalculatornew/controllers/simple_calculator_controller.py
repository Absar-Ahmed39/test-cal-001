...
from apimaticcalculatornew.api_helper import APIHelper
from apimaticcalculatornew.configuration import Configuration
from apimaticcalculatornew.controllers.base_controller import BaseController

class SimpleCalculatorController(BaseController):

    """A Controller to access Endpoints in the apimaticcalculatornew API."""
    ...
    def get_calculate(self,
        ...
        Args:
            operation (OperationEnum): The operator to apply on the variables
